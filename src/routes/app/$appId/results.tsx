  ...
  return (
    <div className="max-w-2xl mx-auto">
      <motion.div
        ...
        className="bg-white rounded-2xl border border-[#F5E6D8] p-8 mb-6"
      >
      ...
      <div className="grid grid-cols-1 gap-6 mb-6">
        ...
        >
          <h3 className="font-display font-bold text-[#3E2723] mb-4">This Session</h3>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl border border-[#F5E6D8] p-5"
        >
          <h3 className="font-display font-bold text-[#3E2723] mb-4">🏆 Leaderboard</h3>
      ...
      >
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-[#F43F5E] hover:bg-[#E11D48] text-white font-display font-bold py-3 px-6 rounded-xl transition-colors"
        >
          <RotateCcw className="h-4 w-4" />
          Try Again
        </button>
        <Link to="/app/$appId" params={{ appId }} className="flex-1">
          <Button variant="outline" className="w-full rounded-xl border-[#F5E6D8] gap-2">
