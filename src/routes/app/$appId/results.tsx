    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 gap-6 mb-6">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#3A3550] rounded-2xl border border-[#F5E6D8] dark:border-[#5A5570] p-5"
        >
          <h3 className="font-display font-bold text-[#3E2723] dark:text-[#F8F8F2] mb-4">🏆 Leaderboard</h3>
      ...
      >
        ...
        <Link to="/app/$appId" params={{ appId }} className="flex-1">
          <Button variant="outline" className="w-full rounded-xl border-[#F5E6D8] dark:border-[#5A5570] dark:text-[#F8F8F2] gap-2">
