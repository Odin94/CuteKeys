  ...
  return (
    ...
    <div className="max-w-lg mx-auto">
      <div className="flex items-center gap-3 mb-8">
        <Link to="/">
          <Button variant="ghost" size="icon" className="rounded-xl text-[#8D6E63] dark:text-[#B0BEC5] cursor-pointer">
            <ArrowLeft className="h-5 w-5" />
          </Button>
        </Link>
        <h1 className="font-display font-black text-2xl text-[#3E2723] dark:text-[#F8F8F2]">Settings</h1>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <label className="font-semibold text-[#3E2723] dark:text-[#F8F8F2] block mb-1">Countdown Duration</label>
          <p className="text-sm text-[#8D6E63] dark:text-[#B0BEC5] mb-3">How many seconds to guess each hotkey</p>
        ...
        >
          <div>
            <label className="font-semibold text-[#3E2723] dark:text-[#F8F8F2] block">Sound Effects</label>
            <p className="text-sm text-[#8D6E63] dark:text-[#B0BEC5]">Play sounds on success and timeout</p>
          </div>
          <motion.button
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#3A3550] rounded-2xl border border-[#F5E6D8] dark:border-[#5A5570] p-5"
        >
          <label className="font-semibold text-[#3E2723] dark:text-[#F8F8F2] block mb-1">Modifier Key Display</label>
          <p className="text-sm text-[#8D6E63] dark:text-[#B0BEC5] mb-3">How to show the primary modifier key</p>
        ...
        >
          <label className="font-semibold text-[#3E2723] dark:text-[#F8F8F2] block mb-1">Danger Zone</label>
          <p className="text-sm text-[#8D6E63] dark:text-[#B0BEC5] mb-3">Permanently delete all your stats and leaderboard data</p>
